...
const ProfileMenu = ({ onEditProfile }: ProfileMenuProps) => {
  ...
  const handleEditProfile = () => {
    ...
    if (onEditProfile) {
      ...
      // Navigate to auth page with edit mode
      navigate('/auth', { state: { editProfile: true } });
    }
  };
      ...
      <AnimatePresence>
        {isOpen && (
          <>
            ...
            {/* Menu */}
            <motion.div
              className="absolute right-0 top-full mt-2 w-48 z-50 rounded-2xl overflow-hidden"
              style={{
