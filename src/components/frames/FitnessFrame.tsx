    ...
    <div className="w-[90%] mx-auto aspect-[9/16] rounded-[20px] overflow-hidden shadow-2xl relative" style={{ background: '#6B6B2A' }}>
      ...
      <div className="absolute top-12 left-4 z-20">
        <h1 
          ...
          style={{ color: '#F4E14D', fontFamily: "'Bebas Neue', sans-serif", letterSpacing: '2px', textShadow: '2px 3px 4px rgba(0,0,0,0.35)' }}
        >
          CULT
        </h1>
        <h2 
          className="text-[54px] font-black leading-[0.95] uppercase"
          style={{ color: '#FFFFFF', fontFamily: "'Bebas Neue', sans-serif", letterSpacing: '2px', textShadow: '3px 4px 8px rgba(0,0,0,0.5)', marginTop: '4px' }}
        >
          NINJA
        </h2>
        {/* Activity name badge */}
