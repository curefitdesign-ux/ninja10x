      ...
      >
        {durationValue ? (
          <div style={{ textAlign: 'left', lineHeight: 1.1 }}>
            <div style={{ fontFamily: "'DM Serif Display', Georgia, serif", fontWeight: 400, fontSize: 'clamp(6px, 2.2vw, 10px)', color: '#696760', letterSpacing: '0.12em', textTransform: 'uppercase', marginBottom: '2px' }}>
              DURATION
            </div>
