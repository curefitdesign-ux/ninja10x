      ...
      >
        {durationValue ? (
          <div style={{ textAlign: 'left', lineHeight: 1.1 }}>
            <div style={{ fontFamily: "'Rowdies', 'Arial', sans-serif", fontWeight: 300, fontSize: 'clamp(6px, 2.2vw, 10px)', color: '#696760', letterSpacing: '0.06em', textTransform: 'uppercase', marginBottom: '2px' }}>
              DURATION
            </div>
