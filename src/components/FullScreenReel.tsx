  ...
  return (
    ...
    >
      ...
      >
        ...
        {/* Swipe left hint at center bottom of story */}
        <motion.div
          className="absolute bottom-20 left-1/2 -translate-x-1/2 z-20 flex items-center gap-2 px-4 py-2 rounded-full pointer-events-none"
          style={{
