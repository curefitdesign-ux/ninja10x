    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        style={{
          ...
          boxShadow: 'var(--glass-highlight), 0 -10px 50px rgba(0, 0, 0, 0.4)',
          ...style,
        }}
        {...props}
      >
        {children}
        <SheetPrimitive.Close className="absolute right-4 top-4 rounded-full w-8 h-8 flex items-center justify-center opacity-70 transition-opacity hover:opacity-100 focus:outline-none disabled:pointer-events-none"
          style={{
