    ...
    return (
      <div className="flex flex-col h-full overflow-hidden overflow-x-clip justify-end">
        <div className="flex-1 flex flex-col justify-end">
            ...
            <div className="flex-1 relative w-full overflow-visible flex items-end justify-center -mt-[50px] mx-auto -translate-x-[1px]" style={{ maxWidth: "370px" }}>
              {showTiles && (
                <motion.img
                  src={journeyPathImg}
                  alt="Journey Path"
        ...
        >
          <LayoutGroup>
            <motion.div className="flex-1 flex flex-col">
              ...
              {/* Progress tiles area */}
              <motion.div 
                className="flex-1 relative w-full overflow-hidden flex items-end justify-center -mt-[50px] mx-auto translate-x-[3px]" 
